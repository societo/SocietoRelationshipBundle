 ...
 */
class FollowerList extends AbstractPageGadget
{
    protected $caption = 'Follower List';

    protected $description = 'A block for displaying list of your follower members';
    ...
    public function execute($gadget, $parentAttributes, $parameters)
    {
        ...
        $builder = $em->getRepository('SocietoRelationshipBundle:Follower')->findFollowerQuery($member->getId());
        ...
        return $this->render('SocietoRelationshipBundle:PageGadget:follower_list.html.twig', array(
            'gadget'    => $gadget,
            'followers' => $pagerfanta->getCurrentPageResults(),
